    ...
    public class PersonsController : ApiController
    {
        ...
        public IHttpActionResult Create()
        {
            ...
            usp_GetPerson_Result obj = new usp_GetPerson_Result()
            {
                ...
                personAddres = httpRequest.Form["adres"].ToString(),
                ...
                passport_vidacha = httpRequest.Form["passport_vidacha"].ToString(),
            };

            try
            {
                var result = db.usp_Persons_IU(null, obj.fam, obj.im, obj.ot, obj.sex, obj.dr, obj.personAddres, obj.person_comment, obj.pers_photo, obj.pass_scan, obj.passport_serie, obj.passport_num, obj.passport_vidacha,obj.cellPhone);
                return Ok(result);
            }
            catch (Exception ex)
            {
        ...
        public IHttpActionResult Put(usp_GetPersonById_Result obj)
        {
            try
            {
                var result = db.usp_Persons_IU(obj.id, obj.fam, obj.im, obj.ot, obj.sex, obj.dr, obj.personAddres, obj.person_comment, obj.pers_photo, obj.pass_scan, obj.passport_serie, obj.passport_num, obj.passport_vidacha, obj.cellPhone);
                return Ok(result);
            }
            catch (Exception ex)
            {
